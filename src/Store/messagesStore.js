...
export const useMessagesStore = create((set, get) => ({
  ...
  getMessages: async (id) => {
    ...
    try {
      ...
      console.error('error in getMessages store:', error);
  ...
  deleteMessage: async (id) => {
    try {
      ...
      console.error('error in deleteMessage store:', error);
  ...
  updateMessage: async (data, id) => {
    try {
      ...
      console.error('error in updateMessage store:', error);
  ...
  getSideBarUsers: async () => {
    try {
      ...
      console.error('Error in getSideBarUsers store:', error);

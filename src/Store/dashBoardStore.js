...
export const useDashBoardStore = create((set,get)=>({
    ...
    deleteFromCreation:async(id)=>{
      try {
        ...
        console.error("Error in deleteFromCreation store:", error);
    ...
    makeAccept: async(data)=>{
      try {
        ...
        console.error("Error in makeAccept store:", error);
    ...
    makeReject: async(id)=>{
      try {
        ...
        console.error("Error in makeReject store:", error);
    ...
    deleteAsk:async(id)=>{
      try {
        ...
        console.error("Error in deleteAsk store:", error);
    ...
    getDashBoardData: async () => {
        try {
          ...
          console.error("Error in getDashBoardData store:", error);
    ...
    getWaitingOrders:async()=>{
      try {
        ...
        console.error("Error in getWaitingOrders store:", error);
    ...
    getDeployedOrdersForMaker: async () => {
      try {
        ...
        console.error("Error in getDeployedOrdersForMaker store:", error);
    ...
    createOrder:async(data)=>{
      try {
        ...
        console.error("Error in createOrde getDashBoardData store:", error);
    ...
    deployOrder2:async(data)=>{
      try {
        ...
        console.error("Error in deployOrder2 store:", error);
    ...
    getWaitingOrdersforMaker: async () => {
      try {
        ...
        console.error("Error in getWaitingOrdersforMaker store:", error);
    ...
    AddToDo: async (id) => {
      try {
        ...
        console.error("Error in AddToDo store:", error);
    ...
    getOrder: async (id) => {
      try {
        ...
        console.error("Error in getOrder store:", error);
    ...
    toggleFavroute:async(routeId)=>{
      try {
        ...
        console.error("Error in toggleFavroute store:", error);
    ...
    getSaved:async()=>{
      try {
        ...
        console.error("Error in getSaved store:", error);
    ...
    getHistory: async () => {
      try {
        ...
        console.error("Error in getHistory store:", error);
    ...
    deleteHistory: async (id) => {
      try {
        ...
        console.error("Error in deleteHistory store:", error);
    ...
    addHistory: async (id) => {
      try {
        ...
        console.error("Error in addHistory store:", error);
    ...
    setDelivered: async (id) => {
      try {
        ...
        console.error("Error in setDelivered store:", error);
